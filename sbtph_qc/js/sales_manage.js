...
function addsalesAgent() {
    ...
    fetch('http://192.168.70.250/sbtph_qc/api/create_sales_agent.php', { method: 'post', body:JSON.stringify(data)} )
    .then(response => {
...
function getAllAgents() {
	...
	fetch('http://192.168.70.250/sbtph_qc/api/sales_manage.php')
	.then(data => {
		data = data.json();
		return data
	}).then(data =>
        ...
        updateBtn.addEventListener('click', function(e){
           ...
           var params = {};
            ...
            // alert(JSON.stringify(params))
             ...
             fetch('http://192.168.70.250/sbtph_qc/api/updatesales.php', {method:'post', body:JSON.stringify(params)})
             .then(response => {
       ...
       // actDelete.style.margin = "4px";
        ...
        actDelete.addEventListener('click',function(e){
            ...
            if(confirm(`Are you sure you want delete ${this.id} Agent? Deleting Agent will automatically delete Agent Records as well`)){
                 fetch('http://192.168.70.250/sbtph_qc/api/delete_sales.php', {method:'post', body:JSON.stringify(params)})
             .then(response => {
                 return response.json()
             }).then(data => {

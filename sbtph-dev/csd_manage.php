...
<html lang="en">
  <head>
    ...
    <title>CSD PHILIPPINES INBOUND MONITORING</title>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="mx-auto" style="width: 200px; padding: 30px;">
              <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#myModal" dataset-backdrop="static" dataset-keyboard="false">ADD AGENT</button>
        </div>   

                           ...
                           while($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                    ...
                                    //This Section Get the Total Answered Called of each agents...
                                     $querycalls = "SELECT StartTimeStamp,EndTimeStamp FROM inbound_callstatus WHERE getDate='".$getdate."' AND CallStatus='ANSWER'  AND ( WhoAnsweredCall='".$row['extension']."' OR WhoAnsweredCall='".$with_iax.$row['extension']."')";

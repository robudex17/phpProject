...
function addcsdAgent() {
    ...
    fetch('http://192.168.70.250/sbtph-api-style/api/create_csd_agent.php', { method: 'post', body:JSON.stringify(data)} )
    .then(response => {
...
function getAllAgents() {
	...
	fetch('http://192.168.70.250/sbtph-api-style/api/csd_manage.php')
	.then(data => {
		data = data.json();
		return data
	}).then(data =>
        ...
        updateBtn.addEventListener('click', function(e){
           ...
           var params = {};
            ...
            // alert(JSON.stringify(params))
             ...
             fetch('http://192.168.70.250/sbtph-api-style/api/updatecsd.php', {method:'post', body:JSON.stringify(params)})
             .then(response => {
       ...
       // actDelete.style.margin = "4px";
        ...
        actDelete.addEventListener('click',function(e){
            ...
            if(confirm(`Are you sure you want delete ${this.id} Agent? Deleting Agent will automatically delete Agent Records as well`)){
                 fetch('http://192.168.70.250/sbtph-api-style/api/delete_csd.php', {method:'post', body:JSON.stringify(params)})
             .then(response => {
                 return response.json()
             }).then(data => {

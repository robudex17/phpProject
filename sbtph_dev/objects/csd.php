   ...
   //create database connection  when this class instantiated
    ...
    public function genMetrics($option,$startDateAndTime,$endDateAndTime,$origstarttime,$orgendtime,$duration_weight,$callcount_weight) {
          ...
          if($option == 'csdinbound'){
            ...
            $this->inbound_metrics($option,$startDateAndTime,$endDateAndTime,$origstarttime,$orgendtime,$duration_weight,$callcount_weight);
          }elseif($option == 'csdoutbound'){
          	 $this->outbound_metrics($option,$startDateAndTime,$endDateAndTime,$origstarttime,$orgendtime,$duration_weight,$callcount_weight);
          }
    ...
    public function login_logout_duration ($log,$extension){
     ...
     public function inbound_metrics($option,$startDateAndTime,$endDateAndTime,$origstarttime,$orgendtime,$duration_weight,$callcount_weight){
    ...
    public function getMetricsTotalAgentTimeStamp($option,$startDateAndTime, $endDateAndTime, $extension){
     ...
     public function outbound_metrics($option,$startDateAndTime,$endDateAndTime,$origstarttime,$orgendtime,$duration_weight,$callcount_weight){

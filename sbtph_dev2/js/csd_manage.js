...
function addcsdAgent() {
    ...
    fetch('http://192.168.70.250/sbtph_dev2/api/create_csd_agent.php', { method: 'post', body:JSON.stringify(data)} )
    .then(response => {
...
function getAllAgents() {
	...
	fetch('http://192.168.70.250/sbtph_dev2/api/csd_manage.php')
	.then(data => {
		data = data.json();
		return data
	}).then(data =>
        ...
        updateBtn.addEventListener('click', function(e){
           ...
           var params = {};
            ...
            // alert(JSON.stringify(params))
             ...
             fetch('http://192.168.70.250/sbtph_dev2/api/updatecsd.php', {method:'post', body:JSON.stringify(params)})
             .then(response => {

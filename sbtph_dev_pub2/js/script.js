...
const HTTPADDR = "http://103.5.6.2/sbtph_dev_pub2/";
...
function alreadyLogin() {
  ...
  if (jwt != ''){
    window.location.href = 'http://103.5.6.2/sbtph_dev_pub2/'
  }
...
function getLoginUser() {
  ...
  if (jwt === ''){
    window.location.href = 'http://103.5.6.2/sbtph_dev_pub2/login.php';
  }else{

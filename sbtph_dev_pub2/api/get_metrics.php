...
$collection = new Collection($db);
 ...
 if(isset($_GET['group']) && isset($_GET['start_date_and_time']) && isset($_GET['end_date_and_time'])  && isset($_GET['option_metrics']) && isset($_GET['duration_weight']) && isset($_GET['callcount_weight'])){
    ...
    if($option == 'collection'){
       $stmnt = $collection->genMetrics($option,$startDateAndTime,$endDateAndTime,$_GET['start_date_and_time'],$_GET['end_date_and_time'],$_GET['duration_weight'],$_GET['callcount_weight']);
    }else{
       $stmnt = $csd->genMetrics($option,$startDateAndTime,$endDateAndTime,$_GET['start_date_and_time'],$_GET['end_date_and_time'],$_GET['duration_weight'],$_GET['callcount_weight']);
    }

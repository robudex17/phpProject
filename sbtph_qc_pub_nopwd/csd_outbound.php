...
<body class="bg-light" onload="getOutboundCallSummary()" >
...
<div class="nav-scroller bg-blue shadow-sm">
      <nav class="nav nav-underline">
        ...
        <a class="nav-link btn btn-primary btn-lg active" href="csd_outbound.php">CSD-OUTBOUND</a>
              ...
              <table class="table">
                <thead class="thead-dark">
                   <tr>
                      ...
                      <th scope="col">
                        <form action="csd_outbound.php" id="form_date">
 ...
 <script src="js/csd_outbound.js"></script>

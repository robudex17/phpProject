  ...
  <body class="bg-light" onload="getAllAgents()">
    ...
    <div class="nav-scroller bg-blue shadow-sm">
          <nav class="nav nav-underline ">
                 ...
                 <a class="nav-link btn btn-primary btn-lg active" href="sales_manage.php">MANAGE SALES AGENTS</a>          
          </nav>
    </div>
              ...
              <form method="POST" id="addAgent">
                  ...
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <label class="input-group-text" for="inputGroupSelect01">Team Leader</label>
                    </div>
                  
                    <select class="custom-select" name="teamleader" form="addAgent" required id="teamleader">
                       <option value="BRY">BRY</option>
                       <option value="CHEL">CHEL</option>
                        <option value="DON">DON</option>
                        <option value="IVAN">IVAN</option>
                        <option value="JOMAN">JOMAN</option>
                        <option value="JHUN">JHUN</option>
                        <option value="KEN">KEN</option>
                        <option value="MHEL">MHEL</option>
                        <option value="PAULA">PAULA</option>
                        <option value="RUSTAN">RUSTAN</option>
                        <option value="SALLY">SALLY</option>
                        <option value="ZARWIN">ZARWIN</option>
                    </select>
                </div>
                  <hr>
          ...
          <thead>
            <tr>
              ...
              <th scope="col"><h3>Name</h3></th>
               <th scope="col"><h3>Team Leader</h3></th>
